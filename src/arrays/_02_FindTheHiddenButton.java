...
public class _02_FindTheHiddenButton implements ActionListener{
	...
	public void start() {
		...
		String a = JOptionPane.showInputDialog("enter a whole positive number");
...
buttons= new JButton[num];
	...
	frame.pack();
		...
		JOptionPane.showMessageDialog(null, "In this game all you have to do it try to guess what button is the secret super amazing button. if you do you get a high 5");
